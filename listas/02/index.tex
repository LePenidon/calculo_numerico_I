...
\item \itensLetras{
    ...
    \ea{
        A = H H^{\intercal} \implies\matriz{b}{4 & 2 & -4 \\ 2 & 10 & 4 \\ -4 & 4 & 9} = \matriz{p}{a & 0 & 0 \\ b & c & 0 \\ d & e & f}\matriz{p}{a & b & d \\ 0 & c & e \\ 0 & 0 & f}
    }
    ...
    Por 1:
    \ea{
        \matriz{b}{4 & 2 & -4 \\ 2 & 10 & 4 \\ -4 & 4 & 9} \matriz{p}{x \\ y \\ z} = \matriz{p}{2x +y -2z \\ 3y+2z \\ z}
    }

    Por 2:
    \ea{
        \matriz{p}{2 & 0 & 0 \\ 1 & 3 & 0 \\ -2 & 2 & 1}\matriz{p}{2x +y -2z \\ 3y+2z \\ z} = \matriz{p}{0 \\ 6 \\ 5}
        \\
        \implies
...
\item \itensLetras{
    ...
    Portanto:
    \ea{
        L = \matriz{p}{1 & 0 & 0 \\ \frac{-1}{4} & 1 & 0 \\ \frac{3}{4} & \frac{1}{5} & 1}; \quad U = \matriz{b}{-4 & 2 & 5 \\ 0 & \frac{-9}{2} & \frac{9}{4} \\ 0 & 0 & 3}
    }
