...
\item \itensLetras{
    ...
    Resolvendo a multiplicação de matrizes:
    \ea{
        H = \matriz{b}{ 2 & 0 & 0 \\ 1 & 3 & 0 \\-2 & 2 & 1};
    }


    \item Sabemos que:
    \ea{
        \det \parenteses{A} = \parenteses{\det\parenteses{H}}^2 = \parenteses{2\cdot3\cdot1}^2 = 36
    }
    ...
    Por 1:
    \ea{
        \matriz{b}{2 & 1 & -2 \\ 0 & 3 & 2 \\ 0 & 0 & 1} \matriz{b}{x \\ y \\ z} = \matriz{b}{2x +y -2z \\ 3y+2z \\ z}
    }
    ...
    \ea{
        ...
        \\
        \implies
        \system{4x +2y -4z &= 0 \\ 2x +10y +4z &= 6 \\ -4x +4y +15z &= 5}
    }
